...
class StepMotor:
    ...
    def __init__(self, GPIOused=[2,3]) -> None:
        self.loaction = 0           # +-整数
        ...
        self.方向pin = Pin(GPIOused[1],Pin.OUT,Pin.PULL_DOWN)
    ...
    def 改变电机位置(self, l):  # 一路
        ...
        if d == self.direction:
            print("D:", self.loaction)
            pass
        else:
            self.changeDirection(1-self.direction)
            print("changeD:", self.loaction)
